# cratis.no — project context

The Norwegian landing page for Cratis. Static content site.

## Conventions

- Norwegian copy on this site (cratis.io carries the English canon); keep the
  two consistent in substance.
